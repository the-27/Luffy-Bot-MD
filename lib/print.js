...
export default async function (m, conn = { user: {} }) {
    ...
    console.log(`${chalk.greenBright('╔═════════════•═[ 𝙇𝙐𝙁𝙁𝙔 𝘽𝙊𝙏 ]═•═════════════')}
${chalk.magentaBright('║')} ${chalk.black(chalk.bgCyanBright('%s'))} ${chalk.cyanBright(oraColombia)}
${chalk.yellowBright('║')}❍ㅤ- ${chalk.cyanBright('%s')}
${chalk.cyanBright('║')}⌨ - ${chalk.cyanBright('%s [%s %sB]')}
${chalk.magentaBright('║')}✦ - ${chalk.white('%s')}
${chalk.yellowBright('║')}⎗ -ㅤ${chalk.cyanBright('%s%s')}
${chalk.cyanBright('║')}❑ -ㅤ${chalk.cyanBright(chatName)}
${chalk.magentaBright('║')}⎙ -ㅤ${chalk.cyanBright('%s')}
${chalk.yellowBright('╚═════════════•═[ 𝗖𝗢𝗡𝗦𝗢𝗟𝗔 ]═•═════════════')}`.trim(),
